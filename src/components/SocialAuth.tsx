  ...
  return (
    <div className="flex flex-col space-y-3 w-full">
      ...
      <button
        ...
        disabled={isLoading}
        className={`flex items-center justify-center gap-3 w-full h-14 rounded-2xl font-bold text-[#191919] transition-all
      ...
      <div className="flex flex-col gap-1.5">
        <button
          ...
          disabled={isLoading}
          className={`flex items-center justify-center gap-3 w-full h-14 rounded-2xl font-bold text-white transition-all
      ...
      <button
        ...
        disabled={isLoading}
        className="flex items-center justify-center gap-3 w-full h-14 bg-white border border-gray-300 rounded-2xl shadow-sm hover:bg-gray-50 transition-all text-[#3c4043] font-bold"
      >
        {isLoading ? (
