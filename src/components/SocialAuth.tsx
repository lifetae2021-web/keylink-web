...
export default function SocialAuth({ isAdmin, isLoading, setIsLoading, lastMethod, redirectUrl }: SocialAuthProps) {
  ...
  const handleKakaoLogin = () => {
    ...
    setIsLoading(true);
    const kakaoAuthUrl = `https://kauth.kakao.com/oauth/authorize?client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&state=${state}&scope=profile_nickname,account_email&prompt=select_account`;
