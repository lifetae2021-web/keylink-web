    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p style={{ fontSize: '0.85rem', color: '#64748B', marginTop: 2 }}>Keylink 서비스의 수익 모델과 성장 지표를 분석합니다. <span className="text-[10px] font-bold text-[#FF7E7E] ml-2">v7.9.8 Premium</span></p>
        </div>
