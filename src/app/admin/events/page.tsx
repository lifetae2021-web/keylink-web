...
좋은 인연 만날 수 있도록 키링크가 끝까지 책임질게요🥰`;
  ...
  const handleWaitlistSelectConfirm = async (msg: string, price?: number, bypassOverlap?: boolean) => {
...
당일 현장에서 뵙겠습니다! 좋은 인연 만나시길 바랍니다 :)`;
  ...
  const handleWaitlistConfirmSubmit = async (msg: string, price?: number, bypassOverlap?: boolean) => {
