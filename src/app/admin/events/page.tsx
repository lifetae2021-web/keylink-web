...
export default function EventsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "participants" | "waitlist" | "stats"
  >("overview");
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 text-[0.75rem] font-medium">
                        <span className="flex items-center gap-1 text-slate-700">
                          <Calendar size={11} />
                          {format(active.eventDate, "MM. dd (E) HH:mm", {
                            locale: ko,
                          })}
                        </span>
                        ...
                        <span className="text-slate-200">|</span>
                        <span className="flex items-center gap-1 text-[#FF6F61] font-semibold">
                          <Banknote size={11} />
                          {(active.price || 29000).toLocaleString()}원
                        </span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          {[
                            ...
                            {
                              label: "여성 모집 현황",
                              cur: liveConfirmedFemale,
                              max: active.maxFemale,
                              pct: femaleRatio,
                              color: "#ec4899",
                              bg: "#fdf2f8",
                              border: "#fbcfe8",
                            ...
                            >
                              <div className="flex justify-between mb-4">
                                <span
                                  className="flex items-center gap-2 text-[0.85rem] font-extrabold"
                                  style={{ color: g.color }}
                                >
                              ...
                              <p
                                className="text-right text-[0.8rem] font-extrabold mt-2"
                                style={{ color: g.color }}
                              >
                                {g.pct}%
                              </p>
                              ...
                              >
                                ...
                                {(() => {
                                  ...
                                  const getBirthYear = (app: Application) => {
                                    ...
                                    if (n > 0 && n < 50)
                                      return `${String(2026 - n).slice(-2)}년생`;
                                    ...
                                    <div className="divide-y divide-slate-100">
                                      {slots.map(({ slotNum, app }) => {
                                        ...
                                        return (
                                          <div
                                            key={app.id}
                                            className={`flex items-center gap-3 px-5 py-3.5 hover:bg-slate-50 transition-colors ${isOverQuota ? "bg-red-50 animate-pulse" : ""}`}
                                          >
                                            <span
                                              className={`text-xs font-black w-8 shrink-0 ${isMaleSection ? "text-blue-500" : "text-pink-500"}`}
                                            >
                                              {slotNum}호
                                            </span>
                                            <div className="flex-1 min-w-0">
                                              <div className="flex items-center gap-2 mb-0.5">
                                                ...
                                                <span
                                                  className={`text-[0.65rem] font-bold px-2 py-0.5 rounded-full ${badge.cls}`}
                                                >
                                                  {badge.label}
                                                </span>
                                              </div>
                                      ...
                                      {unassigned.map((app) => {
                                        ...
                                        return (
                                          <div
                                            key={app.id}
                                            className={`flex items-center gap-3 px-5 py-3.5 hover:bg-slate-50 transition-colors ${isOverQuota ? "bg-red-50 animate-pulse" : "bg-amber-50/40"}`}
                                          >
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div className="shrink-0 flex items-center gap-6">
                                        <div>
                                          {app.status === "applied" && (
                                            <span className="text-[0.65rem] font-black px-1.5 py-0.5 rounded-md" style={{ color: '#D97706', background: '#FFFBEB' }}>검토 중</span>
                                          )}
                                          {app.status === "held" && (
                                            <span className="text-[0.65rem] font-black px-1.5 py-0.5 rounded-md" style={{ color: '#EA580C', background: '#FFF7ED' }}>보류</span>
                                          )}
                                          {app.status === "selected" && (
                                            <span className="text-[0.65rem] font-black px-1.5 py-0.5 rounded-md" style={{ color: '#7C3AED', background: '#F5F3FF' }}>입금 대기</span>
                                          )}
