    ...
    <div className="space-y-8 animate-in fade-in duration-400">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p style={{ fontSize: '0.85rem', color: '#64748B', marginTop: 2 }}>실시간 데이터와 서비스 현황을 한눈에 확인합니다. <span className="text-[10px] font-bold text-[#FF6F61] ml-2">v8.12.0 Premium</span></p>
        </div>
      </div>
