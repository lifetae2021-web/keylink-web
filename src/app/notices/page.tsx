...
const faqs = [
  {
    q: '참가비는 얼마인가요?',
    a: '현재 부산/창원 모두 1인 39,000원입니다. 결제 후 행사 당일 현장에서 신분증을 확인합니다.',
  },
  {
    q: '취소/환불이 가능한가요?',
  ...
  {
    q: '행사 장소는 어디인가요?',
    a: '부산은 해운대구 파티룸 모노리(Monory)를 주 장소로 사용하며, 창원은 성산구 선별된 프리미엄 카페에서 진행됩니다. 예약 확정 후 상세 주소를 안내드립니다.',
  },
  {
    q: '매칭 결과는 언제 알 수 있나요?',
...
const notices = [
  ...
  {
    id: 3,
    title: '창원 행사 장소 변경 안내 (4월 이후)',
    date: '2026-03-20',
    isImportant: false,
    content: '4월부터 창원 행사는 카페 아뜰리에에서 진행됩니다. 기존 장소와 동일한 수준의 프리미엄 공간입니다.',
  },
  {
    id: 4,
