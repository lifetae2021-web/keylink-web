                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                color: selected ? '#fff' : (isWarmDisabled ? '#94A3B8' : 'var(--color-text-secondary)'), 
                                border: selected ? '2.5px solid #FF6F61' : (isWarmDisabled ? '1.5px solid #E2E8F0' : '1.5px solid #E2E8F0'),
