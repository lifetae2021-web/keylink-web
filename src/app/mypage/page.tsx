...
export default function MyPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updateData = {
        ...sanitizedForm,
        profilePhotos,
        // Explicitly clear legacy fields to prevent schema conflicts (v3.2.7 Comprehensive Cleanup)
  ...
  // v3.2.7: Client-side image compression to bypass Firestore 1MB document limit
  ...
  const handlePhotoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    files.forEach(file => {
      ...
      reader.onload = async (ev) => {
        ...
        // Apply compression before setting state (v3.2.7)
