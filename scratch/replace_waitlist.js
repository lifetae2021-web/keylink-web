...
// Find the start and end of the waitlist header + items.
// Starting from: <div className="flex items-center gap-2 px-6 py-4" style={{ borderBottom: "1px solid #f1f5f9", background: "#fffbeb", }}>
// Ending after the genderWaitlist mapping block.
...
const replacement = `                                <div
                                  className={\`flex items-center gap-2 px-6 py-4 border-b border-slate-100 bg-orange-50/40\`}
                                >
                                  <span
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <div className="flex-1 min-w-0">
                                          ...
                                          {app.adminMemo && (
                                            <div className="mt-1 flex items-start gap-1 bg-amber-50/50 px-2 py-1 rounded-lg border border-amber-100/50 max-w-fit ml-11 sm:ml-0">
...
code = code.substring(0, startIndex) + replacement + code.substring(endIndex + targetEnd.length);
